...
int main()
{
    ...
    while(1)
    {
        unsigned short rpm = get_rpm();

        unsigned char rpm_data[4];
        ...
        IndicatorStatus status = process_indicator();

        can_transmit(0x30, rpm_data,4);
        _delay((unsigned long)((4000)*(2000000/4000000.0)));

        unsigned int ind_buf[1];
        ind_buf[0] = (unsigned int)status;
        can_transmit(0x50, ind_buf,1);
        _delay((unsigned long)((1000)*(2000000/4000000.0)));
    }
}
